...
{
    public class RepositoryPedidoEnvioMercadoLivre : RepositoryBase<PedidoEnvioMercadoLivre, Guid>, IRepositoryPedidoEnvioMercadoLivre
    {
        public RepositoryPedidoEnvioMercadoLivre(MercadoLivreContext context) : base(context)
        {
        }
    }
}
