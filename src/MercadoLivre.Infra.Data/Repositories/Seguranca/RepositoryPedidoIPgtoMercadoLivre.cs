...
{
    public class RepositoryPedidoPgtoMercadoLivre : RepositoryBase<PedidoPgtoMercadoLivre, Guid>, IRepositoryPedidoPgtoMercadoLivre
    {
        public RepositoryPedidoPgtoMercadoLivre(MercadoLivreContext context) : base(context)
        {
        }
    }
}
