...
using NewBank.Infra.Data.Repositories.Seguranca;
using NewBank.Infra.Data.UoW;
...
namespace NewBank.WebApi
{
    public static class Setup
    {
        ...
        {
            services.AddDbContext<NewBankContext>(options =>
            {
        ...
        {
            var assemblyCoreDomain = AppDomain.CurrentDomain.Load("NewBank.Core.Domain");
        ...
        {
            var assemblySegurancaDomain = AppDomain.CurrentDomain.Load("NewBank.Seguranca.Domain");
